...
const BuildingCalculatorComponent: React.FC = () => {
  ...
  const [buildingListText, setBuildingListText] = useState<string>(() => {
    const loaded = loadBuildingListText();
    return loaded || '';
  });
                ...
                >
                  ...
                  <div className="card-actions justify-end mt-4 gap-4">
                    <button
                      ...
                      className="btn btn-primary btn-sm gap-2 flex-none"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                    ...
                    <button
                      ...
                      className="btn btn-error btn-sm gap-2 flex-[3]"
